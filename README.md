...
* 追加機能: 敵の行動
C0C24005:入江諒
キャラクターを四角形から「カービィ」に変更し、見た目を本格的なゲーム風にした
カービィは左右に動いたり、スペースキーでジャンプしたりできるようになっている
Zキーを押すとカービィが炎を吐く機能を追加した
炎は進行方向に飛び、しばらくすると消えるようになっている
「動く・跳ぶ・攻撃する」3つのアクションができる、より完成度の高いゲームになった